...
{
	//Adding print statements for debug purposes only
	Serial.println("Starting wire.begin");
	Wire.begin();        // join I2C bus

  // initialize variables
  Serial.println("starting variable initialization");
  for (byte i = 0; i < 4; i++) {
    cellVoltages[i] = 0;
  }
...
{
	Serial.println("Determining i2c address and whether CRC is enabled");
    I2CAddress = 0x08;
    crcEnabled = true;
...
//----------------------------------------------------------------------------
/***** for the arduino - doesn't support CRC
